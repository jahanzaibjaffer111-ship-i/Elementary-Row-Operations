...
public class matrices_R1_minus_NR2
{
    public static void main(String[] args) 
    {
        try (Scanner read = new Scanner(System.in)) 
        {
            ...
            System.out.println("Entre first row from which u want to minus");
            int row1=read.nextInt();
            row1-=1;
            System.out.println();
            System.out.println("Entre second row from which u want to minus");
            int row2=read.nextInt();
            row2-=1;
            System.out.println();
            System.out.println("entre no u want to multiply with row of second matrix");
            int no=read.nextInt();
